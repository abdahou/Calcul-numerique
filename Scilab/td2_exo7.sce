...
(err_arriere*cond_A)-err_arriere
...
err_arriere1=norm(b1-(A1*xex1))/(norm(A1)*norm(xex1))
...
err_arriere2=norm(b2-(A2*xex2))/(norm(A2)*norm(xex2))
...
err_arriere3=norm(b3-(A3*xex3))/(norm(A3)*norm(xex3))
